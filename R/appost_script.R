appost <- function(){
  ...
  if(PNRR=="Agritech Spoke 3"){
    ...
    Progetto.int <- 'piano nazionale di ripresa e resilienza (PNRR), missione 4 “istruzione e ricerca”, componente 2, investimento 1.4 “potenziamento strutture di ricerca e creazione di campioni nazionali di R&S su alcune key enabling technologies”, decreto direttoriale MUR n. 1032 del 17/06/2022 - progetto “centro nazionale tecnologie dell’agricoltura” (Agritech), spoke 3, codice identificativo CN00000022 - CUP B83C22002840001'
  }
  ...
  if(PNRR=="onFoods Spoke 4"){
    ...
    Progetto.int <- 'piano nazionale di ripresa e resilienza (PNRR), missione 4 “istruzione e ricerca”, componente 2, investimento 1.3, avviso n. 341 del 15 marzo 2022 del ministero dell’università e della ricerca - “partenariati estesi alle università, ai centri di ricerca, alle aziende per il finanziamento di progetti di ricerca di base” - finanziato dall’Unione europea – NextGeneration EU, codice progetto PE00000003, CUP B83C22004790001'
    CUP2 <- "B83C22004790001"
    avviso.pnrr <- " il Decreto Direttoriale 16 dicembre 2021, n. 3138, rettificato con Decreto Direttoriale 18 dicembre 2021, n. 3175,” di emanazione di un Avviso pubblico per la presentazione di Proposte di intervento per il Potenziamento di strutture di ricerca e creazione di “campioni nazionali” di R&S su alcune Key Enabling Technologies da finanziare nell’ambito del Piano Nazionale di Ripresa e Resilienza, Missione 4 Componente 2 Investimento 1.3 finanziato dall’Unione europea – NextGenerationEU;"
  ...
  if(PNRR=="ARES"){
    ...
    Progetto.int <- "piano nazionale di ripresa e resilienza (PNRR), missione 4 'istruzione e ricerca', componente 2, investimento 1.1 'progetti di ricerca di significativo interesse nazionale (PRIN)', finanziamento dell'Unione europea - NextGeneration EU, decreto direttoriale MUR n. 104 del 2/2/2022 - progetto 'CIRCUFUN: Assessment of biodiversity and functional roles of infectious circular viroid-like RNAs in fungi from different ecological niches', codice identificativo 2022F79TR4_LS9_PRIN2022, CUP B53D23017580006"
    logo <- "logo_ares.jpg"
  ...
  Progetto.cup <- paste0(Progetto, " (", CUP2, ")")
...
Si vuole generare ugualmente i documenti dell'operatore economico per richiederli nuovamente?
  ...
  ras.pnrr <- function(){
    ...
    doc <- doc |>
      ...
      body_replace_all_text("CAMPO.DEST.RAS.EMAIL", RSS.email, only_at_cursor = TRUE) |>
      cursor_reach("CAMPO.DELLA.FORNITURA") |>
      body_replace_all_text("CAMPO.DELLA.FORNITURA", toupper(paste0(della.fornitura, " DI “", Prodotto, "”, ordine CNR-IPSP-",
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext(sottoscritto.ric), ftext(" "), ftext(Richiedente, fpt.b), ftext(", "),
                         ...
                         ftext(Richiedente..Data.di.nascita), ftext(", codice fiscale "), ftext(Richiedente..Codice.fiscale), ftext(",")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTA", fpt.b),
                         ftext(" la normativa attinente alle situazioni, anche potenziali, di conflitto di interessi, in qualità di richiedente l'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
    ...
    if(Richiedente!=Responsabile.progetto){
      doc <- doc |>
        ...
        body_add_fpar(fpar(ftext(sottoscritto.resp), ftext(" "), ftext(Responsabile.progetto, fpt.b), ftext(", "),
                           ...
                           ftext(Responsabile.progetto..Data.di.nascita), ftext(", codice fiscale "), ftext(Responsabile.progetto..Codice.fiscale), ftext(",")), style = "Normal") |>
        body_add_fpar(fpar(ftext("VISTA", fpt.b),
                           ftext(" la normativa attinente alle situazioni, anche potenziali, di conflitto di interessi, in qualità di titolare dei fondi e responsabile del "),
                           ftext(Progetto.int),
                           ftext(", in relazione all'affidamento "),
                           ftext(della.fornitura), ftext(" di “"),
                           ftext(Prodotto),
                           ftext("”, ordine CNR-IPSP-"),
                           ftext(sede),
  ...
  rup.pnrr <- function(){
    ...
    doc <- doc |>
      cursor_reach("CAMPO.DELLA.FORNITURA") |>
      body_replace_all_text("CAMPO.DELLA.FORNITURA", toupper(paste0(della.fornitura, " DI “", Prodotto, "”, ordine CNR-IPSP-",
                                                                    sede, " N° ", ordine, y, " (", Pagina.web, "), NELL'AMBITO DEL ", Progetto.int, ".")), only_at_cursor = TRUE) |>
      body_add_par(firma.RSS, style = "heading 2") |>
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("DICHIARAZIONE DI ASSENZA DI SITUAZIONI DI CONFLITTO DI INTERESSI AI SENSI DEGLI ARTT. 46 e 47 D.P.R. 445/2000")), style = "heading 1") |>
      body_add_fpar(fpar(ftext("")), style = "Normal") |>
      body_add_fpar(fpar(ftext(sottoscritto.rss), ftext(RSS, fpt.b), ftext(nato.rss)), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTA", fpt.b),
                         ftext(" la normativa attinente alle situazioni, anche potenziali, di conflitto di interessi, in qualità di "),
                         ftext(RSS.dich),
                         ftext("dell'IPSP e in relazione all'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
      ...
      body_add_fpar(fpar(ftext(sede1), ftext(", "), ftext(da)), style = "Normal") |>
      body_add_fpar(fpar(ftext("")), style = "Normal") |>
      body_add_fpar(fpar(paste0(firma.RSS), run_footnote(x=block_list(fpar(ftext(" Il dichiarante deve firmare con firma digitale qualificata oppure allegando copia fotostatica del documento di identità, in corso di validità (art. 38 del D.P.R. n° 445/2000 e s.m.i.).", fp_text_lite(italic = TRUE, font.size = 7)))), prop=fp_text_lite(vertical.align = "superscript"))), style = "Firma 2") |>
      body_add_fpar(fpar(ftext("("), ftext(RSS), ftext(")")), style = "Firma 2")
    ...
    ## Dati mancanti ---
    manca <- dplyr::select(sc, Prodotto, Progetto, Importo.senza.IVA, Voce.di.spesa, GAE, RUP, Prot..RAS, Pagina.web)
    manca <- as.data.frame(t(manca))
    colnames(manca) <- "val"
    manca$var <- rownames(manca)
    rownames(manca) <- NULL
  ...
  ai.pnrr <- function(){
    ...
    doc <- doc |>
      ...
      body_replace_all_text("CAMPO.OGGETTO", toupper(paste0("AFFIDAMENTO ", della.fornitura, " DI “", Prodotto, "”, ordine CNR-IPSP-",
                                                            sede, " N° ", ordine, y, " (", Pagina.web, "), NELL'AMBITO DEL ", Progetto.int, ".")), only_at_cursor = TRUE) |>
      body_add_par(firma.RSS, style = "heading 2") |>
    ...
    if(Importo.senza.IVA.num>=40000){
      ...
      body_replace_all_text("CAMPO.PROPONE", ftext("la formalizzazione dell’affidamento diretto, immediatamente efficace, nei confronti del predetto O.E."), only_at_cursor = TRUE)
    }else{
      doc <- doc |> 
        cursor_reach("CAMPO.PROPONE") |>
        body_replace_all_text("CAMPO.PROPONE", "la formalizzazione dell’affidamento diretto nei confronti del predetto O.E.", only_at_cursor = TRUE)
    }
    doc <- doc |> 
      body_add_fpar(fpar(ftext("")), style = "Normal") |>
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext(sottoscritto.rup), ftext(" "), ftext(RUP, fpt.b), ftext(", "),
                         ...
                         ftext(RUP..Data.di.nascita), ftext(", codice fiscale "), ftext(RUP..Codice.fiscale), ftext(", ")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTA", fpt.b),
                         ftext(" la normativa attinente alle situazioni, anche potenziali, di conflitto di interessi, in relazione all'incarico di responsabile unico del progetto (RUP) per l'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext(sottoscritto.rup), ftext(" "), ftext(RUP, fpt.b), ftext(", "),
                         ...
                         ftext(", in relazione all'incarico di responsabile unico del progetto (RUP) per l'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
    ...
    ## Dati mancanti ---
    manca <- dplyr::select(sc, Prodotto, Progetto, Importo.senza.IVA, RUP, Prot..RUP, Pagina.web)
    manca <- as.data.frame(t(manca))
    colnames(manca) <- "val"
    manca$var <- rownames(manca)
    rownames(manca) <- NULL
  ...
  dac.pnrr <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("CONSIDERATO", fpt.b), ftext(" che l’operatore economico individuato "),
                         ...
                         ftext(Importo.senza.IVA),
                         ftext(" oltre IVA;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTA", fpt.b), ftext(" l’istruttoria del RUP prot. n. "),
                         ftext(Prot..atto.istruttorio),
                         ftext(", contenente l’esito positivo relativo alla verifica dei requisiti dichiarati in sede di affidamento dall’O.E. "),
                         ftext(Fornitore),
                         ftext(" (P.IVA "),
                         ftext(Fornitore..P.IVA),
                         ftext("), nonché la proposta di affidamento diretto al medesimo O.E. "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("CONSIDERATO ", fpt.b),
    ...
    if(Importo.senza.IVA.num<40000){
      doc <- doc |>
      body_replace_text_at_bkm(bookmark = "bookmark_procedere", paste0("all'acquisizione ", della.fornitura, " di cui trattasi, mediante affidamento diretto", all.OE, 
      ...
      doc <- doc |>
        cursor_reach("CAMPO.PROCEDERE") |>
        body_replace_all_text("CAMPO.PROCEDERE", paste0("all'acquisizione ", della.fornitura, " di cui trattasi, mediante affidamento diretto, immediatamente effice, ", all.OE, 
                                                        ", P.IVA ", Fornitore..P.IVA, ", codice terzo SIGLA ", Fornitore..Codice.terzo.SIGLA, ", con sede legale in ",
                                                        Fornitore..Sede,
                                                        ", che ha presentato la propria offerta, ammontante a ",
                                                        Importo.senza.IVA,
                                                        " oltre IVA,",
                                                        preventivo.individuato), only_at_cursor = TRUE)
    }
    doc <- doc |>
      cursor_reach("CAMPO.DI.IMPEGNARE") |>
      body_remove() |>
    ...
    print(doc, target = paste0(pre.nome.file, "5 Decisione a contrattare.docx"))
    
    cat("\014")
    cat("

    Documento '", pre.nome.file, "5 Decisione a contrattare.docx' generato e salvato in ", pat)
  ...
  ldo.pnrr <- function(){
    ...
    doc <- doc |>
      ...
      body_remove() |>
      cursor_backward() |>
      body_add_fpar(fpar(ftext("Fatturazione", fpt.b), ftext(": la fattura, redatta secondo la normativa vigente, dovrà riportare, pena il rifiuto della stessa, il numero d'ordine (corrispondente al numero di registrazione al protocollo), il CIG e il CUP e la seguente dicitura '"),
    ...
    if(Fornitore..Nazione=="Italiana"){
      ...
      doc <- doc |>
        ...
        body_remove() |>
        cursor_backward() |>
        body_add_fpar(fpar(ftext("Invoice", fpt.b), ftext(": the invoice, drawn up in accordance with current legislation, must include, under penalty of rejection, the order number (corresponding to the registration number in the protocol), the CIG, the CUP and the following wording '"),
                           ftext(dicitura.fattura, fpt.b),
  ...
  docoe.pnrr <- function(){
    if(PNRR!="No"){
      docuOE <- c("Dich_requisiti_infra40",
                  ...
                  "CCNL",
                  "bollo")
      docuOE_ext <- c("4.1 Dichiarazione possesso requisiti di partecipazione e di qualificazione infra 40k",
                      "4.1 Dichiarazione possesso requisiti di qualificazione oltre 40k",
                      "4.3 Dichiarazione DPCM 187 1991",
                      "4.5 Dichiarazione titolare effettivo",
                      "4.7 Dichiarazione obblighi assunzionali",
                      "4.8 Dichiarazione ausiliaria",
                      "4.10 Comprova equivalenza tutele CCNL",
                      "4.11 Comprova imposta di bollo")
      if(Importo.senza.IVA.num<40000){
        docuOE <- docuOE[c(-2,8)]
        docuOE_ext <- docuOE_ext[c(-2,-8)]
      }else{
        docuOE <- docuOE[-1]
    ...
    doc <- read_docx("tmp.docx")
    print(doc, target = paste0(pre.nome.file, "4.2 Comunicazione conto corrente dedicato.docx"))
    # download.file(paste(lnk, "CAM.docx", sep=""), destfile = "tmp.docx", method = "curl", extra = "--ssl-no-revoke", quiet = TRUE)
    # doc <- read_docx("tmp.docx")
    # doc <- doc |>
    #   footers_replace_img_at_bkm(bookmark = "bookmark_footers", external_img(src = logo, width = 3, height = 2, unit = "cm"))
    # print(doc, target = paste0(pre.nome.file, "4.9 Documentazione rispetto CAM.docx"))
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("in relazione all'affidamento "),
                         ...
                         ftext(Progetto.int),
                         ftext(";")), style = "Elenco punto")
      print(doc, target = paste0(pre.nome.file, "4.4 Scheda DNSH apparecchiature.docx"))
      ...
      doc <- doc |>
        ...
        body_add_fpar(fpar(ftext("in relazione all'affidamento "),
                           ...
                           ftext(Progetto.int),
                           ftext(";")), style = "Elenco punto")
      print(doc, target = paste0(pre.nome.file, "4.5 Scheda DNSH chimici.docx"))
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext(sottoscritto.ric), ftext(" "), ftext(Richiedente, fpt.b), ftext(", "),
                         ...
                         ftext(", in qualità di richiedente l'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
      ...
      body_remove() |>
      cursor_backward() |>
      body_add_fpar(fpar("Il richiedente l'affidamento diretto", run_footnote(x=block_list(fpar(ftext(" Il dichiarante deve firmare con firma digitale qualificata oppure allegando copia fotostatica del documento di identità, in corso di validità (art. 38 del D.P.R. n° 445/2000 e s.m.i.).", fp_text_lite(italic = TRUE, font.size = 7)))), prop=fp_text_lite(vertical.align = "superscript"))), style = "Firma 2") |>
      body_add_fpar(fpar(ftext("("),
                         ftext(Dott.ric),
                         ftext(" "),
                         ftext(Richiedente),
      ...
      body_add_fpar(fpar(ftext("("),
                         ...
                         ftext(Richiedente),
                         ftext(")")), style = "Firma 2")
      print(doc, target = paste0(pre.nome.file, "4.6.1 Dichiarazione assenza conflitto interesse titolare effettivo Rich.docx"))
    ...
    doc <- doc |>
      ...
      body_remove() |>
      cursor_backward() |>
      body_add_fpar(fpar(ftext(sottoscritto.rss), ftext(RSS, fpt.b), ftext(","), ftext(nato.rss), 
                         ftext(" in qualità di",),
                         ftext(RSS.dich),
                          ftext("e in relazione all'affidamento "),
                         ftext(della.fornitura), ftext(" di “"),
                         ftext(Prodotto),
                         ftext("”, ordine CNR-IPSP-"),
                         ftext(sede),
      ...
      body_add_fpar(fpar(ftext("("),
                         ftext(RSS),
                         ftext(")")), style = "Firma 2")
      print(doc, target = paste0(pre.nome.file, "4.6.2 Dichiarazione assenza conflitto interesse titolare effettivo RSS.docx"))
...
")
      ...
      # 5: Nomina RUP, Provvedimento d'impegno
