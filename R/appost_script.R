    ...
    if(inpt.oe==1){
      if(Fornitore..Nazione=="Italiana"){
        ...
        doc <- doc.pi |>
          ...
          body_replace_all_text("CAMPO.FORNITORE.PATTO", paste0("L'operatore economico ", Fornitore, " (di seguito Operatore Economico) con sede legale in ", Fornitore..Sede, ", C.F./P.IVA ", Fornitore..P.IVA, ", rappresentato da ", Fornitore..Rappresentante.legale, " in qualità di ", Fornitore..Ruolo.rappresentante, ","), only_at_cursor = TRUE) |>
