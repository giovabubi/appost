...
Digitare il numero d'ordine e premere INVIO per caricare il file 'Ordini.csv' scaricato da Teams
  ...
  dac <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Regolamento di Organizzazione e Funzionamento del Consiglio Nazionale delle Ricerche - DPCNR nr. 144 Prot. n. 531963 del 19 dicembre 2025, in vigore dal 1° febbraio 2026;")), style = "Normal") |>
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Codice di comportamento dei dipendenti del Consiglio Nazionale delle Ricerche approvato con delibera del Consiglio di Amministrazione n° 137/2017 e aggiornato con delibera n° 177/2025, Verb. 521;")), style = "Normal") |>
