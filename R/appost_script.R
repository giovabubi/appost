appost <- function(){
  ...
  cat(paste0("
      ...
      ***************************
      ...
      AppOst è ottimizzata per affidamenti diretti di forniture e servizi
...
Digitare il numero d'ordine e premere INVIO per caricare il file 'Ordini.csv' scaricato da Teams
  ...
  if(sede=='BA'){
    ...
    nomina.RSS <- "533894 del 22/12/2025 di nomina del dott. Giovanni Nicola Bubici quale Responsabile della Sede Secondaria di Bari dell’IPSP per il periodo dall’1/1/2026 al 31/12/2026"
    nomina.RSS2 <- "533894 del 22/12/2025 relativo al conferimento dell’incarico del dott. Giovanni Nicola Bubici a Responsabile delegato alla gestione della sede secondaria di Bari dell’IPSP con decorrenza dall'1/1/2026 al 31/12/2026;"
    ...
    nomina.RSS <- "533898 del 22/12/2025 di nomina del dott. Stefano Ghignone quale Responsabile della Sede Secondaria di Torino dell’IPSP per il periodo dall'1/1/2026 al 31/12/2026"
    nomina.RSS2 <- "533898 del 22/12/2025 relativo al conferimento dell’incarico del dott. Stefano Ghignone a Responsabile delegato alla gestione della sede secondaria di Torino dell’IPSP con decorrenza dall'1/1/2026 al 31/12/2026;"
    ...
    nomina.RSS <- "533897 del 22/12/2025 di nomina della dott.ssa Michelina Ruocco quale Responsabile della Sede Secondaria di Portici dell’IPSP per il periodo dall'1/1/2026 al 31/12/2026"
    nomina.RSS2 <- "533897 del 22/12/2025 relativo al conferimento dell’incarico della dott.ssa Michelina Ruocco a Responsabile delegata alla gestione della sede secondaria di Portici dell’IPSP con decorrenza dall'1/1/2026 al 31/12/2026;"
    ...
    nomina.RSS <- "536797 del 23/12/2025 di nomina del dott. Nicola Luchi quale Responsabile della Sede Secondaria di Sesto Fiorentino dell’IPSP per il periodo dall'1/1/2026 al 31/12/2026"
    nomina.RSS2 <- "536797 del 23/12/2025 relativo al conferimento dell’incarico del dott. Nicola Luchi a Responsabile delegato alla gestione della sede secondaria di Sesto Fiorentino dell’IPSP con decorrenza dall'1/1/2026 al 31/12/2026;"
  ...
  if(PNRR=="Agritech Spoke 1" | PNRR=="Agritech Spoke 3" | PNRR=="Agritech Spoke 8" | PNRR=="Agritech Spoke 4" | PNRR=="onFoods Spoke 2" | PNRR=="onFoods Spoke 3" | PNRR=="onFoods Spoke 4" | PNRR=="onFoods Spoke 6" | PNRR=="SUS-MIRRI.IT" | PNRR=="ITINERIS"){
    finanziamento <- "PNRR"
  }else if(PNRR=="DIVINGRAFT" | PNRR=="ARES" | PNRR=="MINACROP" | PNRR=="MONTANA" | PNRR=="SpecFor" | PNRR=="Mimic" | PNRR=="StreeTLAMP" | PNRR=="Fore-VOC" | PNRR=="XyWall" | PNRR=="AlpEcoArchaeology" | PNRR=="HEMINT" | PNRR=="BIORES" | PNRR=="Intertruffle" | PNRR=="BACBIO" | PNRR=="MOBeeFO" | PNRR=="secrEVome" | PNRR=="SUSHI" | PNRR=="TRSH52" | PNRR=="LICAT" | PNRR=="REMIND" | PNRR=="MYCOVIROLE" | PNRR=="NEGESI" | PNRR=="RiWeCIS" | PNRR=="XyWall"){
  ...
  if(PNRR=="XyWall"){
    titolo <- "Cell wall determinants in plant resistance to Xylella"
    codice.progetto <- "2022F8BZMX_LS9"
    CUP2 <- "B53C24007440006"
    decreto.concessione <- "20427 del 6/11/2024"
    dicitura.fattura <- paste0(finanziamento, " ", PNRR, " - Codice progetto MUR: ", codice.progetto)
    attuatore <- "Consiglio Nazionale delle Ricerche"
  ...
  ras <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("di non trovarsi, rispetto al ruolo ricoperto ed alle funzioni svolte, in alcuna delle situazioni di conflitto d'interesse, anche potenziale, di cui all’art. 16 del D.lgs. n. 36/2023, nonché della vigente normativa in materia, tale da ledere l’imparzialità e l’immagine dell’agire nell’amministrazione;")), style = "Elenco punto") |>
      ...
      body_add_fpar(fpar(ftext("di aver preso piena cognizione del D.P.R. 16 aprile 2013, n. 62 e delle norme in esso contenute, nonché del Codice di comportamento dei dipendenti del Consiglio Nazionale delle Ricerche adottato con delibera del Consiglio di Amministrazione n° 137/2017 e successivo aggiornamento intervenuto con delibera n° 177 del 30 settembre 2025;")), style = "Elenco punto") |>
  ...
  dac <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Regolamento di Organizzazione e Funzionamento del Consiglio Nazionale delle Ricerche emanato con DPCNR nr. 144 Prot. n. 531963 del 19 dicembre 2025, entrato in vigore dal 1° febbraio 2026;")), style = "Normal") |>
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Codice di comportamento dei dipendenti del Consiglio Nazionale delle Ricerche approvato con delibera del Consiglio di Amministrazione n° 137/2017 e successivo aggiornamento intervenuto con delibera del Consiglio di Amministrazione n° 177/2025 del 30 settembre 2025, Verb. 521;")), style = "Normal") |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Bilancio Unico di Previsione del Consiglio Nazionale delle Ricerche per l’esercizio finanziario 2026, approvato dal Consiglio di Amministrazione con deliberazione n. 245/2025 – Verbale 527 del 17 dicembre 2025;")), style = "Normal")
  ...
  provv_ant <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b),
                         ftext(" il Regolamento di Organizzazione e Funzionamento del Consiglio Nazionale delle Ricerche - DPCNR n. 144 Prot. n. 531963 del 19 dicembre 2025, in vigore dal 1° febbraio 2026;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b),
    ...
    doc <- doc |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b),
                         ftext(" il Bilancio Unico di Previsione del Consiglio Nazionale delle Ricerche per l’esercizio finanziario 2026, approvato dal Consiglio di Amministrazione con deliberazione n. 245/2025 – Verbale 527 del 17 dicembre 2025;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTA", fpt.b), ftext(" la Richiesta di Acquisto prot. "),
  ...
  provv_imp <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b),
                         ftext(" il Regolamento di Organizzazione e Funzionamento del CNR emanato con Provvedimento del Presidente nr. 144 Prot. n. 531963 del 19 dicembre 2025, in vigore dal 1° febbraio 2026;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b),
...
#     }
    ...
    Documenti generati: 
        ...
        if(Tipo.acquisizione=="Beni" & Inventariabile=="Non inventariabile"){
          doc <- doc |>
            body_add_fpar(fpar(ftext("3. Durata", fpt.b), ftext(": la fornitura dovrà essere consegnata entro 30 giorni naturali e consecutivi decorrenti dalla data di sottoscrizione della lettera d'ordine presso: "),
                               ftext(Richiedente..Luogo.di.consegna), ftext(".")), style = "Riquadro paragrafo")
        }
        if(Tipo.acquisizione=="Beni" & Inventariabile=="Inventariabile"){
          doc <- doc |>
            body_add_fpar(fpar(ftext("3. Durata", fpt.b), ftext(": la fornitura deovrà essere consegnata e installata entro 30 giorni naturali e consecutivi decorrenti dalla data di sottoscrizione della lettera d'ordine presso: "),
                               ftext(Richiedente..Luogo.di.consegna), ftext(".")), style = "Riquadro paragrafo")
        }
  ...
  ai <- function(){
    ...
    doc <- doc |>
      ...
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il D.lgs. 31 marzo 2023, n. 36 rubricato “Codice dei Contratti Pubblici in attuazione dell’articolo 1 della legge 21 giugno 2022, n. 78, recante delega al Governo in materia di contratti pubblici”, pubblicato sul Supplemento Ordinario n. 12 della GU n. 77 del 31 marzo 2023 (nel seguito per brevità “Codice”);")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il D.lgs. 31 dicembre 2024, n. 209 rubricato “Disposizioni integrative e correttive al codice dei contratti pubblici, di cui al decreto legislativo 31 marzo 2023, n. 36”, pubblicato sul Supplemento Ordinario n.45/L della GU n. 305 del 31 dicembre 2024;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Codice di comportamento dei dipendenti del Consiglio Nazionale delle Ricerche approvato con delibera del Consiglio di Amministrazione n° 137/2017 e successivo aggiornamento intervenuto con delibera del Consiglio di Amministrazione n° 177/2025 del 30 settembre 2025;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Bilancio Unico di Previsione del Consiglio Nazionale delle Ricerche per l’esercizio finanziario 2026, approvato dal Consiglio di Amministrazione con deliberazione n. 245/2025 – Verbale 527 del 17 dicembre 2025;")), style = "Normal") |>
      body_add_fpar(fpar(ftext("VISTO", fpt.b), ftext(" il Regolamento di Organizzazione e Funzionamento del Consiglio Nazionale delle Ricerche emanato con DPCNR n. 144 prot. n. 531963 del 19 dicembre 2025, entrato in vigore dal 1° febbraio 2026;")), style = "Normal") |>
